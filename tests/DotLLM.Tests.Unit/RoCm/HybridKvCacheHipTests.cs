...
/// </summary>
public sealed unsafe class HybridKvCacheHipTests : IDisposable
{
    ...
    // We can't create a real HipKvCache without a GPU, so test the CPU-side routing only.
    ...
    public void CpuLayer_Update_RoutesWithRemappedIndex()
    {
        ...
        // Since we can't create HipKvCache without GPU, we test the SimpleKvCache routing directly.
        int seqLen = 2;
